...
Usage:
    python submit_job_to_cluster --project_id <extreme-arch-376708> --region <us-central1> \
        --cluster_name <my-new-cluster> --job_file_path <my_new_storage_bucket>
"""
import os
import re
...
if __name__ == "__main__":
  ...
  quickstart('extreme-arch-376708', "us-central1", "my-new-cluster", "my_new_storage_bucket", "pyspark_sort.py")
